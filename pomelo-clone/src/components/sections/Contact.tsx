...
export default function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative isolate overflow-hidden bg-[#000339] px-6 pb-28 pt-24 text-white light:bg-[#f1f2f2] light:text-[#000339] sm:px-10">
      <div className="glow-accent absolute inset-0 bg-[radial-gradient(ellipse_50%_46%_at_50%_80%,rgba(22,72,255,0.3),transparent_74%)] light:bg-[radial-gradient(ellipse_50%_46%_at_50%_80%,rgba(52,132,255,0.16),transparent_74%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-[900px] text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="mx-auto mt-5 max-w-[420px] text-[13px] leading-relaxed text-white/70 light:text-[#000339]/70 sm:text-[15px]"
          >
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {team.map((member) => (
            <InteractiveCard
              key={member.name}
              className="batch-card flex flex-col items-center rounded-[14px] border border-white/[0.08] bg-[linear-gradient(160deg,rgba(52,132,255,0.09),rgba(0,3,57,0.55))] px-3 py-5 backdrop-blur-sm light:border-[#000339]/10 light:bg-[linear-gradient(160deg,rgba(52,132,255,0.09),rgba(255,255,255,0.9))]"
            >
