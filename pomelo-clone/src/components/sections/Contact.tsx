...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative isolate overflow-hidden bg-[#000339] px-6 pb-28 pt-24 text-white sm:px-10">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_46%_at_50%_80%,rgba(22,72,255,0.3),transparent_74%)]" />
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {team.map((member, index) => (
            <motion.div
              ...
              className="flex flex-col items-center rounded-[14px] border border-white/[0.08] bg-[linear-gradient(160deg,rgba(52,132,255,0.09),rgba(0,3,57,0.55))] px-3 py-5 backdrop-blur-sm transition-[border-color,box-shadow] duration-300 hover:border-[#80b4ff]/55 hover:shadow-[0_14px_38px_rgba(22,72,255,0.28)]"
            >
