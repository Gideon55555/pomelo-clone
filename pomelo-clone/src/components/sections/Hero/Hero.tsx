    ...
    <section className="relative isolate flex min-h-screen items-center overflow-hidden bg-[#000339] pb-12 pt-28 text-white sm:pt-32">
      ...
      <Container className="relative z-10">
        <div className="mx-auto flex max-w-[660px] flex-col items-center text-center">
          ...
          <Reveal delay={0.35}>
            <div className="mt-7">
            <button className="button-shimmer rounded-[2px] bg-gradient-to-r from-[#1648ff] to-[#3484ff] px-5 py-2.5 text-[11px] font-medium text-white shadow-[0_6px_20px_rgba(22,72,255,0.32)]">
              Contact us
            </button>
            </div>
          </Reveal>
