...
export default function ModularSystem() {
  ...
  return (
    <section id="solutions" className="relative isolate overflow-hidden bg-[#000339] px-6 pb-24 pt-24 text-white light:bg-[#f1f2f2] light:text-[#000339] sm:px-10">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_46%_38%_at_50%_18%,rgba(22,72,255,0.22),transparent_74%)] light:bg-[radial-gradient(ellipse_46%_38%_at_50%_18%,rgba(52,132,255,0.14),transparent_74%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1050px]">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-[520px] text-[13px] leading-relaxed text-white/70 light:text-[#000339]/70 sm:text-[15px]">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-6">
          {modules.map((module, index) => (
            <motion.article
              ...
              className={`group flex flex-col rounded-[14px] border border-white/[0.09] bg-[linear-gradient(150deg,rgba(52,132,255,0.1),rgba(0,3,57,0.6))] p-6 backdrop-blur-sm transition-[border-color,box-shadow] duration-300 hover:border-[#80b4ff]/60 hover:shadow-[0_18px_46px_rgba(22,72,255,0.3)] light:border-[#000339]/10 light:bg-[linear-gradient(150deg,rgba(52,132,255,0.09),rgba(255,255,255,0.9))] light:hover:border-[#1648ff]/45 light:hover:shadow-[0_18px_46px_rgba(22,72,255,0.16)] ${module.span}`}
            >
